...
import { ArrowLeft, Terminal, Cloud, Target, ShieldAlert, GitMerge, Zap, Layout, Network, PenTool, Layers, ExternalLink } from "lucide-react";
  ...
  return (
    <main className="min-h-screen bg-charcoal text-sand font-sans selection:bg-brand-pink selection:text-white">
      ...
      <section className="pt-40 pb-20 px-6 md:px-12 max-w-5xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-brand-purple/50 bg-brand-purple/10 text-brand-light mb-6">
            <Terminal size={12}/>
      ...
      {/* --- THE ARSENAL (High Contrast White Cards) --- */}
      <section className="py-20 px-6 md:px-12 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
            <h2 className="font-serif text-3xl text-white mb-12">The Arsenal.</h2>
                    ...
                    <div className="space-y-6">
                        <div>
                            <div className="flex justify-between items-center mb-1">
                                ...
                                <span className="px-2 py-1 bg-green-100 text-green-700 text-[10px] font-mono uppercase tracking-wide rounded flex items-center gap-1">
                                    Certified
                                </span>
                            </div>
      ...
      {/* --- FOOTER MENU (Dynamic: No Engineering Link) --- */}
      {/* --- REFINED STACKED FOOTER (Dark) --- */}
      {/* --- REFINED STACKED FOOTER (Dark) --- */}
